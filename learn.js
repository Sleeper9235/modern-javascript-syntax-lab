...
const [firstToppping, secondTopping] = pizzaToppings;

console.log(firstToppping, secondTopping);
...
//see exporitngFiles and importingFiles
...
function mySentence(noun = "cat", adjective = "white") {
    return `The ${noun} is ${adjective}`
}
console.log(mySentence())
console.log(mySentence("dog", "brown"))
